package cobaapp.web.repository;

import cobaapp.web.CobaApp;
import cobaapp.web.config.Constants;
import cobaapp.web.config.audit.AuditEventConverter;
import cobaapp.web.domain.PersistentAuditEvent;
...
import static cobaapp.web.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
